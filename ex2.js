...
flightReservation.lightStatus ="Delayed"
console.log("Estado del vuelo:", flightReservation.lightStatus);

// 2. Como compensación del restraso, nos han cambiado el ticket a 'First Class'
flightReservation.ticketClass='First Class';
console.log("Clase: ", flightReservation.ticketClass);

// 3. Como consequencia del retraso, ahora la hora estimada de salida es 9:30 AM. Modifica la propiedad adecuada
flightReservation.departure.time = "9:30 AM.";
console.log("Nueva hora de salida: ", flightReservation.departure.time);
...
console.log("Comidas especiales que se sirven:", flightReservation.specialMeals);
...
let precioBillete = Number(flightReservation.totalPrice.replace("$", ""));
precioBillete  = precioBillete * 0.85;
precioBillete= "$" + precioBillete.toFixed(2);
flightReservation.totalPrice = precioBillete;

console.log("Precio con descuento del 15%: ", flightReservation.totalPrice);
